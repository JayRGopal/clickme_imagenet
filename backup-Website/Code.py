...
model_path = os.getcwd() + '/Models/clickdraw_mobilenet.h5'
...
def finds(our_img):
    vals = ['microwave', 'golf club', 'house plant', 'tooth', 'cat head', 'truck', 'fireplace', 't-shirt', 'carrot', 'pizza slice', 'snorkel', 'megaphone', 'boomerang', 'cactus', 'shorts', 'triangle', 'suitcase', 'pear', 'skateboard', 'saw', 'dolphin', 'map', 'door', 'knife', 'flashlight']
